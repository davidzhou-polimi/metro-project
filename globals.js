...
let playIcon = `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 90 90" fill="currentColor"><path d="M20.54 76.27V12.18l54.74 32.05-54.74 32.05Z"/></svg>`;
let pauseIcon = `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 90 90" fill="currentColor"><path d="M22.23 12.95h11.4l.63.63V76.4l-.63.63h-11.4l-.63-.63V13.59l.63-.63Zm34.14 0h11.4l.63.63V76.4l-.63.63h-11.4l-.63-.63V13.59l.63-.63Z"/></svg>`;
let backIcon = `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 90 90"><path d="M84.17 50.67V39.33h-59.3l24.39-28.89H36.87L5.83 45l31.04 34.56h12.39L24.87 50.67z" fill="currentColor"/></svg>`;
...
let aboutIcon = `<svg width="24" height="24" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 90 90" fill="currentColor"><path d="M39.66 30.73h10.68l.59.56v47.7l-.59.56H39.66l-.59-.56v-47.7zm4.75-20.29h1.19l7.12 7.12v1.19l-7.12 7.12h-1.19l-7.12-7.12v-1.19z"/></svg>`;

let chevronIcon = `<svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24"><rect width="24" height="24" fill="none"/><path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="m6 9 6 6 6-6"/></svg>`;
